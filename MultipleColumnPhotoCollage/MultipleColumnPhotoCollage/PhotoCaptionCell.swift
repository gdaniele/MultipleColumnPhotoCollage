...
public class PhotoCaptionCell: UICollectionViewCell {
  ...
  public func setUpWithImage(image: UIImage, title: String, style: PhotoCaptionCellStyle) {
...
public protocol PhotoCaptionCellStyle {
...
public struct BeigeRoundedPhotoCaptionCellStyle: PhotoCaptionCellStyle {
  public let backgroundColor = UIColor.greenColor().colorWithAlphaComponent(0.2)
  public let cornerRadius: CGFloat = 5
  public let titleFont = UIFont(name: "Avenir", size: 12) ?? UIFont.systemFontOfSize(12)
  public let titleInsets = UIEdgeInsetsMake(5, 5, 5, 5)

  public init() { }
}

// MARK: UIView extension (corner radius)
