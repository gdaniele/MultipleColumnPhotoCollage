...
public protocol MultipleColumnLayoutDelegate: class {
...
public class MultipleColumnLayoutAttributes: UICollectionViewLayoutAttributes {
  public var annotationHeight: CGFloat = 0
...
public class MultipleColumnLayout: UICollectionViewLayout {
  // MARK: Public API
  public weak var delegate: MultipleColumnLayoutDelegate!
